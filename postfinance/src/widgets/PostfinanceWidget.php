...
namespace klarplan\postfinance\widgets;

use klarplan\postfinance\Postfinance;
use klarplan\postfinance\assetbundles\postfinancewidgetwidget\PostfinanceWidgetWidgetAsset;
 ...
 * @since     1.0.0
 */
class PostfinanceWidget extends Widget
{
    ...
    {
        return Craft::t('postfinance', 'PostfinanceWidget');
    }
    ...
    {
        return Craft::getAlias("@klarplan/postfinance/assetbundles/postfinancewidgetwidget/dist/img/PostfinanceWidget-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'postfinance/_components/widgets/PostfinanceWidget_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(PostfinanceWidgetWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'postfinance/_components/widgets/PostfinanceWidget_body',
            [
