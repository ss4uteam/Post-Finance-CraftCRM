...
namespace klarplan\postfinance\fields;

use klarplan\postfinance\Postfinance;
use klarplan\postfinance\assetbundles\postfinancefieldfield\PostfinanceFieldFieldAsset;
 ...
 * @since     1.0.0
 */
class PostfinanceField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('postfinance', 'PostfinanceField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'postfinance/_components/fields/PostfinanceField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(PostfinanceFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').PostfinancePostfinanceField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'postfinance/_components/fields/PostfinanceField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
